...
<div class="page">
	<div style=" "  class="incident-menu-container">
		...
		<p style="font-weight: 400;text-align: center; font-size:20px ;">Enregistrer un incident</p> 
			<form class="form-style" action="" method="post">
						...
						<optgroup label="Pylones">
							<?php 
								foreach($pylons as $pylon){
									echo "<option value=".$pylon['id'].">".$pylon['place']."</option>";
								}
							?>
						</optgroup>
				...
				<div class="form-group">
					...
					<select class="form-control form-control-sm" aria-label="Default select example" id="exampleFormControlTextarea1">
						<?php 
							foreach($equipments as $equipment){
								echo "<option>".$equipment['nom']."</option>";
							}
						?>
					</select>
				</div>
